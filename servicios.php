...
<body>
  ...
  <h1 style="margin-top: 20px;text-align: center;" class="display-5">Nuestros Servicios</h1>
  <center>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      ?>
        ...
        <div class="col-sm-12 col-md-4 col-xl-3 col-xxl-3 mt-5 " id="Servicios-content">
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              <center>
                <h3 class="titulo-item mb-4"> <?php echo $mostrar['Descripcion'] ?></h3>
              </center>
              <input type="hidden" id="Nombre<?php echo $mostrar['PK_codigo_se'] ?>" value="<?php echo $mostrar['Descripcion'] ?>">
              <div class="valor">
                <center><span class="titulo-item"> $<?php echo $mostrar['valor_servicio'] ?></span></center>
                <input type="hidden" id="Valor<?php echo $mostrar['PK_codigo_se'] ?>" value="<?php echo $mostrar['valor_servicio'] ?>">
              </div>
              <br>
              <center><button class="btn btn-primary botones Agregar" id="AddToshop<?php echo $mostrar['PK_codigo_se'] ?>" data-imagen="<?php echo 'data:image/jpeg;base64, ' . base64_encode($mostrar['Imagen']); ?>">Agregar</button></center>
            </div>
          </div>
  ...
  <div id="editarModal" class="modal">
    <div class="modal-content">
      <!-- Aquí coloca el formulario del primer documento -->
