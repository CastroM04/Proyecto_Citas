...
<body>
<footer class="tm-bg-gray pt-5 pb-3 tm-text-gray tm-footer" style="max-width: 100%;">
    <div class="container-fluid tm-container-small">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 px-5 mb-5">
                ...
                <a href="#" class="tm-text-gray text-right d-block mb-2">Condiciones De Uso</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-12 px-5 text-right">
                Diseñado Por:
                <a href="#   " class="tm-text-gray" rel="sponsored" target="_parent">RYS</a>
            </div>
        </div>
    </div>
</footer>
